/**
 * Purchase Filters Component - Production Version
 * Location: app/components/dashboards/purchase/PurchaseFilters.tsx
  ...
  return (
    <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        {/* Period Filter - Only show if periods available */}
