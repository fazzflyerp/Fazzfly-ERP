/**
 * Payroll Filters Component - UI Matched to Finance (Color Overrides Only)
  ...
  return (
    <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-200 shadow-sm">
      ...
      {loading && selectedYear && (
        <div className="mb-4 bg-purple-50 border border-purple-200 rounded-lg p-3 flex items-center gap-3">
